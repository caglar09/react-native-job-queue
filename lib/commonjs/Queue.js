...
} /* eslint-disable no-extra-boolean-cast */ /* eslint-disable @typescript-eslint/no-empty-function */
...
class Queue extends _eventemitter.default {
    ...
    configure(options) {
        const { onQueueFinish = (executedJobs) => {}, updateInterval = 10, concurrency = -1 } = options;
