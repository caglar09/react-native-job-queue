...
exports.default = exports.QueueError = exports.Queue = void 0;
...
function _toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); } /* eslint-disable no-extra-boolean-cast */ /* eslint-disable @typescript-eslint/no-empty-function */
 ...
 * ```
 */
class Queue extends _eventemitter.default {
  static get instance() {
  ...
  constructor() {
    ...
    this.jobStore = _reactNative.NativeModules.JobQueue;
    this.workers = {};
  ...
  cancelJob(jobId, exception) {
    ...
    if (promise !== undefined && typeof promise[_Worker.CANCEL] === 'function') {
      promise[_Worker.CANCEL](exception || new QueueError(`job canceled`, "cancelled"));
    } else if (!promise[_Worker.CANCEL]) {
  ...
  scheduleQueue() {
    if (_reactNative.AppState.currentState === 'active' && _reactNative.Platform.OS === "ios") {
...
var _default = exports.default = Queue.instance;
